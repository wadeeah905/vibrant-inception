...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description: 'Notre sirop de dattes premium est un concentré naturel obtenu par extraction à froid du sucre des dattes Deglet Nour. Sa texture onctueuse et sa saveur intense en font un édulcorant idéal pour napper vos desserts, parfumer vos boissons ou remplacer le miel dans vos recettes. Source de minéraux et d\'oligoéléments, ce nectar de dattes est aussi délicieux sur des crêpes, gaufres ou dans vos préparations culinaires.',
